...
export class WakuService extends HttpConnection {
  ...
  public getFilterTopicMessages(filter: string, cb: IMessageCB) {
  ...
  public async onNewFilterTopicMessage(filterTopic: string, cb: IMessageCB) {
