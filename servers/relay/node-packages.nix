...
let
  sources = {
    ...
    "@types/node-14.18.5" = {
      ...
      version = "14.18.5";
      src = fetchurl {
        url = "https://registry.npmjs.org/@types/node/-/node-14.18.5.tgz";
    ...
    "@types/pino-pretty-4.7.4" = {
      ...
      version = "4.7.4";
      src = fetchurl {
        url = "https://registry.npmjs.org/@types/pino-pretty/-/pino-pretty-4.7.4.tgz";
        sha512 = "h//vRnIpr+9wzyzuwy1dtUNsPNGog/YvZJMEbwBUAVe5/wSHDLdy5qYV0k+TpRDqHYhOdAoLbw5K+wM24e/wHw==";
      };
    };
    ...
    "@walletconnect/relay-api-1.0.2" = {
      ...
      version = "1.0.2";
      src = fetchurl {
        url = "https://registry.npmjs.org/@walletconnect/relay-api/-/relay-api-1.0.2.tgz";
        sha512 = "6FZP6pAQwQttncuWAKC0lGvNm0SCiBEfpkdzURMoGIk4H3u5PpiUHNt9wekPzDl5CYIdVhN2RheH6uS8SuDAZw==";
      };
    };
    ...
    "fastify-3.25.3" = {
      ...
      version = "3.25.3";
      src = fetchurl {
        url = "https://registry.npmjs.org/fastify/-/fastify-3.25.3.tgz";
        sha512 = "20SbobjjMfjGNCU4PlcZis3d5XLDtQxIbcAf6ogi/8zPxRxOOkKwfjmj7yW9Q1VnxDpBwcllwPtbZ/LyvQzXbQ==";
      };
    };
    "fastify-error-0.3.1" = {
      name = "fastify-error";
    ...
    "light-my-request-4.7.0" = {
      ...
      version = "4.7.0";
      src = fetchurl {
        url = "https://registry.npmjs.org/light-my-request/-/light-my-request-4.7.0.tgz";
        sha512 = "LTa8YZp3K2AUpqUnwwKajoIHcsKOBnzwJNQSrk7unziPwo6CjOYjyO0F9wfkxFvP+nBsCGe3eMPnedVgIIgdAw==";
      };
    };
    ...
    "sonic-boom-2.5.0" = {
      ...
      version = "2.5.0";
      src = fetchurl {
        url = "https://registry.npmjs.org/sonic-boom/-/sonic-boom-2.5.0.tgz";
        sha512 = "zqxF6/LwJRn/twgva2GzabvBh2TeSEzstfnZ44kr0nB7+tFJJbixMlm4VUH/1FPjTf0sHQePoH8TlkfYNvXSPA==";
      };
    };
    "source-map-0.6.1" = {
      name = "source-map";
  ...
  args = {
    ...
    dependencies = [
      ...
      sources."@types/node-14.18.5"
      sources."@types/pino-6.3.12"
      sources."@types/pino-pretty-4.7.4"
      ...
      sources."@walletconnect/relay-api-1.0.2"
      ...
      sources."leven-2.1.0"
      (sources."light-my-request-4.7.0" // {
        dependencies = [
          sources."ajv-8.8.2"
