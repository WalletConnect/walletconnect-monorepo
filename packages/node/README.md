# WalletConnect Node SDK

Node SDK for WalletConnect

## Install

```bash
yarn add @walletconnect/node @walletconnect/qrcode-terminal

# OR

npm install --save @walletconnect/node @walletconnect/qrcode-terminal
```
...
walletConnector.on("connect", (error, payload) => {
  ...
  console.log('Connected! main account: ', accounts[0])
